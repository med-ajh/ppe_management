    ...
    <div class="card shadow-lg ">
      <div class="card-header pb-0 pt-3 ">
        <div class="{{ (Request::is('rtl') ? 'float-end' : 'float-start') }}">
          <h5 class="mt-3 mb-0">Epp Managemert User Interface  Configurator</h5>
        </div>
      ...
      <div class="card-body pt-sm-3 pt-0">
        ...
        <a class="btn bg-gradient-dark w-100" href="https://www.creative-tim.com/product/soft-ui-dashboard-laravel" target="_blank">Med ajh</a>
