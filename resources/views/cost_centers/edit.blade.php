...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Edit Cost Center') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('cost_centers.update', $costCenter->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $costCenter->name) }}" required>
                            ...
                            <div class="col-md-6">
                                <select id="department_id" name="department_id" class="form-control @error('department_id') is-invalid @enderror" required>
                                    @foreach($departments as $department)
                                        <option value="{{ $department->id }}" {{ $department->id == $costCenter->department_id ? 'selected' : '' }}>
                                            {{ $department->name }}
                                        </option>
                                    @endforeach
                                </select>
