...
<div>
    <div class="container-fluid">
        <div class="page-header min-height-300 border-radius-xl mt-4" style="background-image: url('../assets/img/curved-images/te.jpg')">
        ...
        <div class="card card-body blur shadow-blur mx-4 mt-n6">
            <div class="row gx-4">
                ...
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                            ...
                            @if($user->role === 'manager')
                                <img src="{{ asset('../assets/img/manager.png') }}" alt="Manager" class="img-fluid" style="max-width: 200px;">
                            @elseif($user->role === 'admin')
                                <img src="{{ asset('../assets/img/admin.png') }}" alt="Admin" class="img-fluid" style="max-width: 200px;">
                            @elseif($user->role === 'employee')
                                <img src="{{ asset('../assets/img/employee.png') }}" alt="User" class="img-fluid" style="max-width: 200px;">
                            @endif
                ...
                <div class="col-auto my-auto">
                    ...
                    <div class="h-100">
                        <h5 class="mb-1 capitalize-first-letter">
                            {{ $user->name }} {{ $user->lastname }}
                        </h5>
                        <p class="mb-0 font-weight-bold text-sm capitalize-first-letter">
                            {{ $user->role }}
                        </p>
                    </div>
                </div>
        ...
        <div class="card mb-4">
            ...
            <br>
                ...
                <div class="text-center mt-3">
                    <a href="{{ route($user->role . '.dashboard') }}" class="btn btn-primary">Back to Dashboard</a>
                </div>
